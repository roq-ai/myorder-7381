              ...
              {hasAccess('order', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                <Stack spacing={2} mb={8}>
                  <Flex justifyContent="space-between">
                    ...
                    <NextLink passHref href={`/orders/create?company_id=${data?.id}`}>
                      ...
                      <Tbody>
                        {data?.order?.map((record) => (
                          <Tr cursor="pointer" onClick={() => router.push(`/orders/view/${record.id}`)} key={record.id}>
                            ...
                            <Td>{record.weight}</Td>
                            <Td>{record.purity}</Td>
                            <Td>{record.screw_type}</Td>
                            <Td>{record.rhodium_details}</Td>
                            <Td>{record.delivery_date as unknown as string}</Td>
                            <Td>
